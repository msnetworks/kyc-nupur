        ...
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                ...
                <ul class="breadcrumbs pull-left">
                    ...
                    <li><a href="<?php echo e(route('admin.banks.index')); ?>">All Bank</a></li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                <div class="form-check">
                                    <input type="checkbox" name="bank_products[]" class="form-check-input" id="<?php echo e($i); ?>Management" value="<?php echo e($product->id); ?>">
                                    <label class="form-check-label" for="checkPermission"><?php echo e($product->name); ?></label>
                                </div>
                            </div>
                        </div>
                        <?php $i++; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\kyc-live\resources\views/backend/pages/banks/create.blade.php ENDPATH**/ ?>