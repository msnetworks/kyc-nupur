    ...
    <form action="{{ route('admin.case.modifyBVCase', $case->id) }}" method="POST">
        ...
        <table class="table table-bordered">
            <tbody>
                ...
                <tr class="bg-info text-white">
                    <td colspan="4" class="subheading text-center"><strong>Location</strong></td>
                </tr>
                <tr>
                    <td>Latitude</td>
                    <td><input type="number" step="0.01" name="latitude" class="form-control" value="{{ $case->latitude ?? '' }}"></td>
                    <td>Longitude</td>
                    <td><input type="number" step="0.01" name="longitude" class="form-control" value="{{ $case->longitude ?? '' }}"></td>
                </tr>
                <tr>
                    <td>Address</td>
                    <td colspan="3"><input type="text" name="latlong_address" class="form-control" value="{{ $case->latlong_address ?? '' }}"></td>
                </tr>
                <tr>
