    ...
    <tbody>
        ...
        <tr style="border: 2px solid #000;">
            <td style="width: 30%; text-align: center; vertical-align: middle; border: 2px solid #000;">
                <img alt="{{ $case->getCase->bank_id == 13 ? 'SK ENTERPRISES' : 'TIGER 4 INDIA LTD' }}" src="{{ $logo }}" style="max-width: 100%; height: auto; max-height: 120px;">
            </td>
        ...
        <!-- Case Details -->
        <tr style="border: 2px solid #000;">
            <td style="border: 2px solid #000; text-align: center;" colspan="2"><strong>State Bank of India <br> {{ optional($case->getCase->getProduct)->name }} {{ $case->getFiType->name }}</strong></td>
        </tr>
        <tr style="border: 2px solid #000;">
        ...
        <!-- Remarks Section -->
        <tr style="border: 2px solid #000;">
            <td style="width: 30%; border: 2px solid #000; text-align: left;">Assesment Year</td>
