                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6 col-sm-12">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input #fytpe_checkbox" type="checkbox" id="Checkbox{{ $key }}" onclick="toggleFields('field{{ $fitype['fi_code'] }}', this)" name="fi_type_id[{{ $key }}][id]" value="{{ $fitype['id'] }}" rel-name="{{ $fitype['fi_code'] }}">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6 col-sm-12">
                                <span class="d-none" id="pan_card_block">
                                    ...
                                    <input type="text" class="form-control" id="pan_card" name="pan_card" value="{{ old('pan_card') }}" placeholder=" Enter Pan Card">
                                </span>
                            </div>
                            <div class="form-group col-md-6 col-sm-12">
                                <span class="d-none" id="aadhar_card_block">
                                    <label for="aadhar_card">Aadhar Card <span class="text-danger">*</span></label>
                                    <input type="number" minlength="12" maxlength="12" class="form-control" id="aadhar_card" name="aadhar_card" value="{{ old('aadhar_card') }}" placeholder=" Enter Aadhar Card">
                                </span>
                            </div>
                        </div>
                        <div class="form-row">
